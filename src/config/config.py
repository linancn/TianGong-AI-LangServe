...
PINECONE_NAMESPACE_REPORT = config["PINECONE"]["NAMESPACE_REPORT"]
PINECONE_NAMESPACE_EDUCATION = config["PINECONE"]["NAMESPACE_EDUCATION"]
PINECONE_NAMESPACE_ALI = config["PINECONE"]["NAMESPACE_ALI"]
...
XATA_ALI_DB_URL = config["XATA"]["ALI_DB_URL"]
...
SUPABASE_KB_URL = config["SUPABASE"]["KB_URL"]
SUPABASE_KB_KEY = config["SUPABASE"]["KB_KEY"]
